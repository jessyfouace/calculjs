...
function exerciceStart(){
    ...
    let randomTopNumber = Math.floor(Math.random() * 9999)
    ...
    for (let index = 0; index < difficultyTable.length; index++) {
        if (difficultyTable[index] == 'facile') {
            ...
            randomTopNumber = Math.floor(Math.random() * (1000 - 51) + 51)
            randomBotNumber = Math.floor(Math.random() * (50 - 20) + 20)
        } else if (difficultyTable[index] == 'difficile') {
            randomTopNumber = Math.floor(Math.random() * (9999 - 81) + 81)
            randomBotNumber = Math.floor(Math.random() * (80 - 50) + 2)
        }
    }
